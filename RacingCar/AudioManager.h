...
public:
	...
	//Sets the BGM (Background music) to play using the provided file, loops = -1 is infinite looping (default: -1)
	void PlayMusic(std::string filename, int loops = -1);

	//Pauses the currently playing BGM if there is anywwdsww
	void PauseMusic();
